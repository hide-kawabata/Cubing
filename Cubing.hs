...
checkOne :: Q -> Bool
checkOne q = sel (w q) 2 /= White && sel (w q) 4 /= White &&
...
threeToFive q
  | sel (w q) 2 == White &&
    sel (w q) 4 == White &&
    sel (w q) 6 /= White &&
    sel (w q) 8 /= White = [B, U, L, U', L', B']
  | sel (w q) 2 /= White &&
    sel (w q) 4 == White &&
    sel (w q) 6 == White &&
    sel (w q) 8 /= White = [U, B, U, L, U', L', B']
  | sel (w q) 2 /= White &&
    sel (w q) 4 /= White &&
    sel (w q) 6 == White &&
    sel (w q) 8 == White = [U, U, B, U, L, U', L', B']
  | sel (w q) 2 == White &&
    sel (w q) 4 /= White &&
    sel (w q) 6 /= White &&
    sel (w q) 8 == White = [U', B, U, L, U', L', B']
...
fiveToNine q
  | sel (r q) 5 == White &&
    sel (o q) 7 == White &&
    sel (g q) 5 == White &&
    sel (g q) 7 == White = [R, U, U, R', R', U', R, R, U', R', R', U, U, R]
  | sel (w q) 1 == White &&
    sel (w q) 3 == White &&
    sel (o q) 5 == White &&
    sel (o q) 7 == White = [R, R, D', R, U, U, R', D, R, U, U, R]
  | sel (r q) 5 == White &&
    sel (b q) 5 == White &&
    sel (o q) 5 == White &&
    sel (w q) 1 == White = [R, U, R', U, R, U', U', R']
  | sel (r q) 7 == White &&
    sel (b q) 7 == White &&
    sel (g q) 7 == White &&
    sel (w q) 5 == White = [R, U', U', R', U', R, U', R]
  | sel (r q) 7 == White &&
    sel (r q) 5 == White &&
    sel (o q) 7 == White &&
    sel (o q) 5 == White = [R, U', U', R', U', R, U, R', U', R, U', R']
  | sel (r q) 7 == White &&
    sel (b q) 5 == White &&
    sel (w q) 3 == White &&
    sel (w q) 7 == White = [L, F', F', R', R', D, R, D', R, F', F', L']
  | sel (r q) 7 == White &&
    sel (w q) 3 == White &&
    sel (w q) 5 == White &&
    sel (o q) 5 == White = [L, F, R', F', L', F, R, F']
